...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO pharmacy (name, location, phoneNumber, emailAddress, operator, passwordHash) VALUES (?, ?, ?, ?, ?, ?)");
...
<body>
    ...
    <h2 class="text-center">Pharmacy Registration</h2>
